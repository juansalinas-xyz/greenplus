              ...
              <div className='w-full flex justify-center gap-1 mt-0'>
                <Reveal>
                  <div className='w-full flex justify-center flex-col gap-10 mt-0 text-center md:block md:justify-start md:flex-row md:w-auto md:gap-0 '>
                    <h1 className={`hidden font-black text-5xl mb-20 md:block md:text-5xl md:mb-5`}>Construye un futuro sostenible con Green Plus</h1>
                    <h4 className='flex justify-center text-center text-2xl font-bold md:text-lg mb-7 md:mb-0 md:mt-4 md:block md:font-normal md:text-center'>Green Plus es una solución innovadora que combina tecnología de punta como blockchain y machine learning para gestionar la huella de carbono corporativa de forma eficiente y transparente.</h4>
