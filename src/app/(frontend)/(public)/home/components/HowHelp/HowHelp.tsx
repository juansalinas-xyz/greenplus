  ...
  return (
    <div className="my-12 w-screen flex justify-center">
      <div style={{width: '75%'}}>
        ...
        <Reveal>
          <div className="flex items-end w-full h-96 mb-12 rounded-lg bg-cover bg-center shadow-xl bg-fixed" style={{backgroundImage: 'url(/landing/howhelp/fondo_howhelp.jpg)'}}>
