...
function OurProjects() {
  ...
  return (
    <div className='w-full h-full flex flex-col justify-center items-center mt-10'>
      ...
      <span id='proyectos' className='text-3xl text-black font-black mt-10 flex justify-center'>Proyectos de compensación</span>
        <div className="mt-10 flex flex-row justify-center gap-7 text-black bg-white p-4 rounded-xl">
          <label className='flex gap-3 items-center'>
            ...
            />
            <p>{Math.max(...projects.map(project => project.price))}</p>
          </label>
          <label className='flex gap-3 items-center'>
          ...
          <label className='flex gap-3 items-center'>
            ...
            <p>{Math.min(...projects.map(project => project.timescale))}</p>
            <input
              type="range"
