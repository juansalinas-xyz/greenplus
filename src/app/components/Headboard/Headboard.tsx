                ...
                <Reveal>
                  <div className='w-full flex justify-center flex-col gap-10 mt-0 text-center md:block md:justify-start md:flex-row md:w-auto md:gap-0 '>
                    ...
                    <Link href={''} className='w-full flex justify-center md:w-auto md:block'>
                      <button onClick={scrollToContact} className='z-50 w-28 rounded-full p-2 bg-white text-black font-bold hover:bg-green_greenplus hover:text-white transition-all duration-500 md:mt-9 hover:scale-105'>
                        Contáctanos
                      </button>
                    </Link>
                  </div>
